...
func configList(b *presets.Builder, db *gorm.DB, shortURLCfg *shorturl.Config) {
	...
	mm.Listing().PageFunc(func(ctx *web.EventContext) (r web.PageResponse, err error) {
		...
		r.Body = h.Components(
			...
			web.Portal(
				...
				fileChooserDialogContent(db, mediaLibraryListField, ctx, &media_library.MediaBoxConfig{}, shortURLCfg),
