...
type Messages struct {
	PageTitle               string
	SiteWideTitle           string
	SiteWideDescription     string
	...
	Seo                     string
	UseDefaults             string
	DynamicMessage          map[string]string
}

var Messages_en_US = &Messages{
	PageTitle:               "SEO Setting",
	SiteWideTitle:           "Site-wide Settings",
	SiteWideDescription:     "Here you can set site-wide variables and preferences for metadata.",
...
var Messages_zh_CN = &Messages{
	PageTitle:               "搜索引擎优化设置",
	SiteWideTitle:           "全站设置",
	SiteWideDescription:     "您可以在此处设置站点范围的变量和首选项。",
