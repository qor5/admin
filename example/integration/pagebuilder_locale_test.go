...
INSERT INTO public.page_builder_pages (id, created_at, updated_at, deleted_at, title, slug, category_id, status, online_url, scheduled_start_at, scheduled_end_at, actual_start_at, actual_end_at, version, version_name, parent_version, locale_code, seo) VALUES (1, '2024-05-17 15:25:39.716658 +00:00', '2024-05-17 15:25:39.716658 +00:00', null, 'test002_en', '/123', 1, 'draft', '', null, null, null, null, '2024-05-19-v01', '2024-05-19-v01_en', '', 'International', '{"OpenGraphImageFromMediaLibrary":{"ID":0,"Url":"","VideoLink":"","FileName":"","Description":""}}');
...
func TestPageBuilderVersion(t *testing.T) {
	...
	cases := []TestCase{
...

		{
			...
			ExpectPortalUpdate0ContainsInOrder: []string{"Localize", "Japan"},
			ExpectPortalUpdate0NotContains:     []string{"International"},
		},
		{
			...
			ReqFunc: func() *http.Request {
				...
				req := NewMultipartBuilder().PageURL("/pages").
					...
					AddField("localize_to", "International").
