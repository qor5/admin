...
INSERT INTO public.page_builder_pages (id, created_at, updated_at, deleted_at, title, slug, category_id, status, online_url, scheduled_start_at, scheduled_end_at, actual_start_at, actual_end_at, version, version_name, parent_version, locale_code, seo) VALUES (3, '2024-05-17 15:25:39.716658 +00:00', '2024-05-17 15:25:39.716658 +00:00', null, '12312', '/456', 1, 'draft', '', null, null, null, null, '2024-05-18-v01', '2024-05-18-v01', '', 'Japan', '{"OpenGraphImageFromMediaLibrary":{"ID":0,"Url":"","VideoLink":"","FileName":"","Description":""}}');
...
func TestPageLocation(t *testing.T) {
	...
	cases := []TestCase{
		...
		},
		{
			...
			ExpectPageBodyContainsInOrder: []string{"/345"},
			ExpectPageBodyNotContains:     []string{"/123", "/456"},
		},
		{
			Name:  "Japan Location",
			Debug: true,
			...
			ExpectPageBodyContainsInOrder: []string{"/456"},
			ExpectPageBodyNotContains:     []string{"/123", "/345"},
		},
	}
