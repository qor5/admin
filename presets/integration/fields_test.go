	...
	cases := []testCase{
		{
			...
			expect: `
<div v-if='!dash.visible || dash.visible["Float1"]'>
...
`,
		},
		{
			...
			expect: `
<div v-if='!dash.visible || dash.visible["Int1"]'>
...
<div v-if='!dash.visible || dash.visible["String1"]'>
...
<div v-if='!dash.visible || dash.visible["Bool1"]'>
...
<div v-if='!dash.visible || dash.visible["Time1"]'>
<div v-model='form["Time1"]' v-assign='[form, {"Time1":"2019-08-29"}]' class='time-control'></div>
</div>

<div v-if='!dash.visible || dash.visible["Company.Name"]'>
...
<div v-if='!dash.visible || dash.visible["Company.FoundedAt"]'>
...
<div v-if='!dash.visible || dash.visible["Media1"]'></div>
`,
		},

		{
			...
			expect: fmt.Sprintf(`
<div v-if='!dash.visible || dash.visible["ID"]'>
<td>1</td>
</div>
...
`, time1LocalFormat),
...

		{
			...
			expect: `
<div v-if='!dash.visible || dash.visible["Media1"]'>context value1, context value2</div>
`,
		},
		{
...
<div v-if='!dash.visible || dash.visible["Time2"]'>
...
<div v-if='!dash.visible || dash.visible["%sAddress.Detail"]'>
<div>
<label class='v-label theme--light text-caption'>Detail</label>

<v-card :variant='"outlined"' class='mx-0 mt-1 mb-4 px-4 pb-0 pt-4'>
<div v-if='!dash.visible || dash.visible["%sAddress.Detail.Address1"]'>
...
<div v-if='!dash.visible || dash.visible["%sAddress.Detail.Address2"]'>
<vx-field label='Address2' v-model='form["%sAddress.Detail.Address2"]' :error-messages='dash.errorMessages["%sAddress.Detail.Address2"]' v-assign:append='[dash.errorMessages, {"%sAddress.Detail.Address2":null}]' v-assign='[form, {"%sAddress.Detail.Address2":"%s"}]' :disabled='false'></vx-field>
		...
		formKeyPrefix,
		formKeyPrefix, formKeyPrefix, formKeyPrefix, formKeyPrefix, formKeyPrefix, v.City,
		formKeyPrefix,
		formKeyPrefix, formKeyPrefix, formKeyPrefix, formKeyPrefix, formKeyPrefix, v.Detail.Address1,
		formKeyPrefix, formKeyPrefix, formKeyPrefix, formKeyPrefix, formKeyPrefix, v.Detail.Address2,
	)
}
...
<div v-if='!dash.visible || dash.visible["Name"]'>
<input name='Name' type='text' value='Name 1'>
</div>

<div v-if='!dash.visible || dash.visible["Departments"]'>
<div class='departments'>
<div v-if='!dash.visible || dash.visible["Departments[0].Name"]'>
<input name='Departments[0].Name' type='text' value='11111'>
</div>

<div v-if='!dash.visible || dash.visible["Departments[0].Employees"]'>
<div class='employees'>
<div v-if='!dash.visible || dash.visible["Departments[0].Employees[0].Number"]'>
<input name='Departments[0].Employees[0].Number' type='text' value='111'>
</div>

%s

<div v-if='!dash.visible || dash.visible["Departments[0].Employees[0].FakeNumber"]'>
<input name='Departments[0].Employees[0].FakeNumber' type='text' value='900111'>
</div>

<div v-if='!dash.visible || dash.visible["Departments[0].Employees[2].Number"]'>
<input name='Departments[0].Employees[2].Number' type='text' value='333'>
</div>

%s

<div v-if='!dash.visible || dash.visible["Departments[0].Employees[2].FakeNumber"]'>
...
<div v-if='!dash.visible || dash.visible["Departments[1].Name"]'>
<input name='Departments[1].Name' type='text' value='22222'>
</div>

<div v-if='!dash.visible || dash.visible["Departments[1].Employees"]'>
<div class='employees'>
<div v-if='!dash.visible || dash.visible["Departments[1].Employees[0].Number"]'>
<input name='Departments[1].Employees[0].Number' type='text' value='333'>
</div>

%s

<div v-if='!dash.visible || dash.visible["Departments[1].Employees[0].FakeNumber"]'>
<input name='Departments[1].Employees[0].FakeNumber' type='text' value='900333'>
</div>

<div v-if='!dash.visible || dash.visible["Departments[1].Employees[1].Number"]'>
<input name='Departments[1].Employees[1].Number' type='text' value='444'>
</div>

%s

<div v-if='!dash.visible || dash.visible["Departments[1].Employees[1].FakeNumber"]'>
...
<div v-if='!dash.visible || dash.visible["PeopleCount"]'>
...
<div v-if='!dash.visible || dash.visible["Departments[0].Employees[3].Number"]'>
<input name='Departments[0].Employees[3].Number' type='text' value='444'>
</div>

%s

<div v-if='!dash.visible || dash.visible["Departments[0].Employees[3].FakeNumber"]'>
<input name='Departments[0].Employees[3].FakeNumber' type='text' value='900444'>
</div>

<div v-if='!dash.visible || dash.visible["Departments[0].Employees[4].Number"]'>
<input name='Departments[0].Employees[4].Number' type='text' value='555'>
</div>

%s

<div v-if='!dash.visible || dash.visible["Departments[0].Employees[4].FakeNumber"]'>
