...
func (this headerStyle) Value() (driver.Value, error) {
	return json.Marshal(this)
}

func (this *headerStyle) Scan(value interface{}) error {
	switch v := value.(type) {
	case string:
...
func SetHeroStyleComponent(pb *pagebuilder.Builder, eb *presets.EditingBuilder) {
	fb := pb.GetPresetsBuilder().NewFieldsBuilder(presets.WRITE).Model(&headerStyle{}).Only("Layout", "TopSpace", "BottomSpace", "ImageBackground")
