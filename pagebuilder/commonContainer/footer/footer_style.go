...
func (this footerStyle) Value() (driver.Value, error) {
	return json.Marshal(this)
}

func (this *footerStyle) Scan(value interface{}) error {
	switch v := value.(type) {
	case string:
...
func SetHeroStyleComponent(pb *pagebuilder.Builder, eb *presets.EditingBuilder) {
	fb := pb.GetPresetsBuilder().NewFieldsBuilder(presets.WRITE).Model(&footerStyle{}).Only("Layout", "TopSpace", "BottomSpace", "ImageBackground")
