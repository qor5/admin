...
func HeroBody(data *Hero, input *pagebuilder.RenderInput) (body HTMLComponent) {
	...
	if backgroundImgUrl == "" && !data.Style.ImgInitial {
		backgroundImgUrl = "https://s3-alpha-sig.figma.com/img/2091/847f/23aed5f700c8474f29fededd296394ba?Expires=1734912000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=LmpcBano56oNL0jVh6IHDRhAMCfMVmM2N6yEMlo-TCcBlKIdB3eYBOLkOCZWY~arsOiotjZN~yByJbLBXEZOG3b5JTWyXMjcE6CuONVBTimfHftQEqLPssW4UjIhEc1Xyl~BMt~5BXD4vg8fNz5qb-pUOqQEcwXDMayVI7hf3gGIqjDkpqDB0Xb8~v6-sZsbP-AxOYZg65eKECq188sWftjRsqmt85WIJvcNjtiSQvdd0fCQz3fbft535yMNpzsX6c9M9L7~H3ySGlxFIR-qj-02Z-8Lcyu-GgKFf~p31u-qXzqTMr5tcRz6VVQ1bIraAvF0sCK~8k1nmWNQHUV7HQ__"
	}
	...
	heroBody := Div(
			...
			Div(
				...
				Template(
					Div(
						...
						Class("order-1 xl:w-[500px] xl:min-h-[400px] md:min-h-[251px] min-h-[135px] relative md:w-[314px] w-[169px] overflow-hidden flex-shrink-0 xl:ml-10 md:ml-[20px] ml-3").
		...
		).Class(fmt.Sprintf(" bg-white text-[#212121] bg-no-repeat bg-cover bg-center pt-[%dpx] pb-[%dpx]", data.Style.TopSpace, data.Style.BottomSpace)).
