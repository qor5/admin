...
INSERT INTO public.page_builder_containers (id, created_at, updated_at, deleted_at, page_id, page_version, page_model_name, model_name, model_id, display_order, shared, hidden, display_name, locale_code, localize_from_model_id) VALUES (3, '2025-03-03 07:49:46.922736 +00:00', '2025-03-03 07:49:46.922736 +00:00', null, 1, '2025-03-03-v01', 'pages', 'Hero', 2, 3, false, false, 'Hero', '', 0);
...
INSERT INTO public.container_tailwind_hero (id, content, style) VALUES (2, '{"Title":"This is a title","Body":"From end-to-end solutions to consulting, we draw on decades of expertise to solve new challenges in e-commerce, content management, and digital innovation.","Button":"Get Start","ButtonStyle":"unset","ImgInitial":false,"ImageUpload":{"ID":0,"Url":"","VideoLink":"","FileName":"","Description":""}}', '{"Layout":"left","TopSpace":0,"BottomSpace":0,"ImgInitial":false,"ImageBackground":{"ID":0,"Url":"","VideoLink":"","FileName":"","Description":""}}');
...
`, []string{"page_builder_pages", "page_builder_containers", "container_tailwind_footer", "container_tailwind_header", "container_tailwind_hero", "container_tailwind_hero_list", "container_tailwind_hero_vertical"}))
	...
	cases := []multipartestutils.TestCase{
		{
			...
			ExpectPageBodyContainsInOrder: []string{"TailWindExampleFooter", "TailWindExampleHeader", "Hero", "TailWindHeroVertical", "TailWindHeroList"},
		},
	}
